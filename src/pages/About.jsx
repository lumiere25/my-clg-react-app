...
const About = () => {
  return (
    ...
    <h1>Some info about me: :)</h1>
     <p> I am a fresh graduate in the field of Frontend Development which I hopw to grow in knowledge and skill set to design beautiful welcoming sites for future clients.
